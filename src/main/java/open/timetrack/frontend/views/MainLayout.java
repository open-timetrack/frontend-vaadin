package open.timetrack.frontend.views;
...
import open.timetrack.frontend.views.opentimetrack.OpenTimeTrackView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        H1 appName = new H1("OpenTimeTrack");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[] { //
                                    new MenuItemInfo("OpenTimeTrack", "la la-columns", OpenTimeTrackView.class), //
