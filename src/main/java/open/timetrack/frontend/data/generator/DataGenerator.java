package open.timetrack.frontend.data.generator;
...
import open.timetrack.frontend.data.service.SamplePersonRepository;
    ...
    public CommandLineRunner loadData(SamplePersonRepository samplePersonRepository) {
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 6, 8, 0, 0, 0));
